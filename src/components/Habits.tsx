      ...
      <div className="px-5 md:px-6 py-4 space-y-6 pb-20 text-[#eff3f4] animate-slide-up duration-[3000ms]">
        ...
        <div className="space-y-4">
          <div className="flex flex-col">
            <h2 className="text-[20px] md:text-[22px] font-black text-[#eff3f4] leading-tight tracking-tight whitespace-nowrap">
              Monthly Checking
            </h2>
            <div className="flex items-center gap-2 mt-1.5 px-0.5">
              <Clock className="w-3.5 h-3.5 text-[#1d9bf0]" strokeWidth={3} />
              <span className="text-[11px] md:text-[12px] font-black text-[#8b98a5] tracking-widest uppercase">
          ...
          <div className="relative w-full max-w-full">
            ...
            <input
              ...
              className="w-full bg-[#16181c] border border-[#2f3336] pl-10 pr-10 py-3 rounded-xl text-[14px] text-[#eff3f4] placeholder-[#71767b] outline-none focus:border-[#1d9bf0] transition-all focus:bg-black/40"
            />
            {searchTerm && (
              <button
                onClick={() => setSearchTerm('')}
                className="absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 flex items-center justify-center rounded-full bg-[#71767b]/30 hover:bg-[#71767b]/50 transition-colors"
              >
        ...
        <div className="flex flex-col gap-8 pb-32 mt-4">
